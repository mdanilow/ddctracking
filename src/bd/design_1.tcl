...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins centroid_0/clk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins rgb2ycbcr_0/clk] [get_bd_pins wysw_0/clk]
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins mux_0/pixel_in_0] [get_bd_pins rgb2ycbcr_0/pixel_in]
  connect_bd_net -net dvi2rgb_0_vid_pHSync [get_bd_pins dvi2rgb_0/vid_pHSync] [get_bd_pins mux_0/h_sync_0] [get_bd_pins rgb2ycbcr_0/h_sync_in]
  connect_bd_net -net dvi2rgb_0_vid_pVDE [get_bd_pins dvi2rgb_0/vid_pVDE] [get_bd_pins mux_0/de_in_0] [get_bd_pins rgb2ycbcr_0/de_in]
  connect_bd_net -net dvi2rgb_0_vid_pVSync [get_bd_pins dvi2rgb_0/vid_pVSync] [get_bd_pins mux_0/v_sync_0] [get_bd_pins rgb2ycbcr_0/v_sync_in]
  ...
  connect_bd_net -net rgb2ycbcr_0_de_out [get_bd_pins centroid_0/de] [get_bd_pins mux_0/de_in_1] [get_bd_pins rgb2ycbcr_0/de_out] [get_bd_pins wysw_0/de_in]
  connect_bd_net -net rgb2ycbcr_0_h_sync_out [get_bd_pins centroid_0/hsync] [get_bd_pins mux_0/h_sync_1] [get_bd_pins rgb2ycbcr_0/h_sync_out] [get_bd_pins wysw_0/hsync_in]
  connect_bd_net -net rgb2ycbcr_0_v_sync_out [get_bd_pins centroid_0/vsync] [get_bd_pins mux_0/v_sync_1] [get_bd_pins rgb2ycbcr_0/v_sync_out] [get_bd_pins wysw_0/vsync_in]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins mux_0/pixel_in_1] [get_bd_pins wysw_0/pixel_in] [get_bd_pins xlconcat_0/dout]
